...
const MonitoringPage: React.FC = () => {
  ...
  const currentResult = {
    ...mockResult,
    ...result,
    confidence: result?.confidence ?? mockResult.confidence,
        ...
        <AnimatedSection delay={0.1} className="mb-8">
          <div className="bg-white rounded-2xl shadow-xl p-6 border border-green-100">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="bg-green-50 rounded-xl py-6 px-4 border border-green-200">
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <Sprout className="w-5 h-5 text-green-600" />
                      <div>
                        <p className="font-semibold text-gray-800">Crop Type</p>
                        <p className="text-gray-600">{currentResult.crop}</p>
                      </div>
                    </div>
